"""
Alpha Engine — Interactive Streamlit UI

Provides a browser-based interface for the UK Systematic Trading Research Framework.
Configure universe, strategies, date range, and risk parameters in the sidebar,
then run a backtest and explore results across interactive tabs.
